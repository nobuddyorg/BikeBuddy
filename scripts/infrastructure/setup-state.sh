...
# The state storage account must exist BEFORE `tofu init` (tofu can't create its
# own backend, a chicken-and-egg problem). Idempotent. After running, set
# storage_account_name in main.tf (see infrastructure/README.md).
set -euo pipefail
