...
| `init-cosmos.js` *(in `functions/scripts/`)* | Create the `bikebuddy` DB + containers in the emulator. | env: `COSMOS_CONNECTION_STRING`, `COSMOS_DATABASE`. | `e2e-fullstack.yml`, local dev |
