# BikeBuddy documentation

Organised by the [Diátaxis](https://diataxis.fr) framework — four kinds of docs,
...
| **How-to guides** | Achieving a specific goal | [User guide](how-to/user-guide.md) · [Developer guide](how-to/developer-guide.md) · [Infrastructure](how-to/infrastructure.md) · [Add a language](how-to/adding-a-language.md) · [Load testing](how-to/load-testing.md) |
...
the [Getting started](tutorials/getting-started.md) tutorial.
